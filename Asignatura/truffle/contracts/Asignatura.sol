...
contract Asignatura {
    ...
    string public version = "2020 Full";
    ...
    */
    ...
    /// Tipos de notas: sín Usar, no presentado, y nota normal entre 0 y 1000.
    ...
    **/
    ...
    // Dada la direccion de un alumno, y el índice de la evaluacion, devuelve
    // la nota del alumno, 10
    ...
    */
    ...
    function addProfesor(address _addr, string memory _nombre) soloOwner soloAbierta

    public {
        require(bytes (datosProfesor[_addr]).length == 0, "Ese profesor ya ha sido added como profesor");
        require(bytes(_nombre).length != 0, "El nombre del profeser no puede ser vacio");
    ...
    *
    * @param _nombre El nombre del alumno. 1
    ...
    **/
    ...
    function _matricular(address _addr, string memory _nombre, string memory _dni,
    string memory _email) soloNoMatriculados soloAbierta private {
    ...
    *
    * @return _nombre El nombre del alumno que invoca el meto:
    ...
    * @param _minimo La nota minima necesaria para aprobar. (Multiplicado por 100 para soportar dos decimales)
    *
    ...
    */
    ...
    function califica(address alumno, uint evaluacion, TipoNota tipo, uint calificacion) soloProfesor soloAbierta public {
        ...
        require(evaluacion < evaluaciones.length, "No se puede calificar una 1 evaluacion que no existe.");
    ...
    /**
    * Devuelve el tipo de nota y la calificacion que ha do el alumno que invoca el metodo en la evaluacion pasada como parametro.
    *
    ...
    *
    * Si el tipo de nota de alguna de las evaluaciones es Empty, es decir, aun no se ha asignado la calificacion,
    * entonces este metodo devuelve (Empty, 0).
    ...
    * @param _addr La address del alumno.
    *
    * @return tipo El tipo de nota que ha sacado el alum
    * @return calificacion La calificacion que ha sacado el alumno.
    */
    ...
    *
    * @return true sí es una alumno matriculado.
    */
    ...
    */
    ...
    /**
    *Modificador para que una funcion solo la pueda ejecutar un ¿ o matriculado.
    */
    ...
    /**
    * Modificador para que una funcion solo la pueda ejecutar un alumno no matrículado aun.
    */
    ...
    */
    ...
    modifier soloAbierta() {
        require(!cerrada, "Solo permitido si la Signatura no esta cerrada");
        _;
    }
